...
public static async Task<HttpResponseMessage> Run(HttpRequestMessage req, TraceWriter log)
{
    ...
    var storageAccount = CloudStorageAccount.Parse(ConfigurationManager.AppSettings["datacollectionblobstoragecn"]);
    ...
    log.Info($"will send a SAS in container '{container.Name}' with permissions '{permissions}'");
